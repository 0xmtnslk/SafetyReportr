      ...
      <header className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 shadow-sm z-30 flex items-center justify-between px-4">
        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center">
            ...
            <span className="text-lg font-bold text-gray-900">Sağlık, Emniyet Çevre Yönetimi</span>
          </div>
        </div>
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex items-center justify-between px-4 py-4 border-b border-gray-200">
                <div className="flex items-center">
                  ...
                  <span className="font-bold text-gray-900">Sağlık, Emniyet Çevre Yönetimi</span>
                </div>
                <button
                  onClick={() => setIsMobileMenuOpen(false)}
        ...
        <div className="flex items-center justify-between px-4 h-full">
          <div className="flex items-center">
            ...
            <div className="flex items-center ml-2">
              ...
              <span className="font-semibold text-gray-900 text-sm">Sağlık, Emniyet Çevre Yönetimi</span>
            </div>
          </div>
