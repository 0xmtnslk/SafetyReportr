 ...
 * @param props.folder - Upload folder type: 'profiles' or 'logos' (default: 'profiles')
...
export function ObjectUploader({
  ...
  return (
    <div>
      <Button onClick={() => setShowModal(true)} className={buttonClassName} data-testid={`button-upload-${folder}`}>
        {children}
      </Button>
      ...
      <DashboardModal
        ...
        locale={{
          strings: {
            // Turkish translations for better UX
            addMoreFiles: 'Daha fazla dosya ekle',
            addMore: 'Daha fazla ekle',
            dropPasteFiles: 'Dosyaları buraya sürükleyip bırakın veya %{browseFiles}',
