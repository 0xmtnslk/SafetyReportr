...
// Component for Inspection Results Admin Tab
function InspectionResultsAdmin() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Kontrol Listesi Bazlı Denetim Sonuçları</h2>
